...
const Projects = () => {
  ...
  const projects = [
    {
      title: "Purrrch",
      description: "A creative, identity-driven web experience designed and built end-to-end. Focused on tone, motion, and a distinctive visual voice.",
      technologies: ["React", "Tailwind CSS", "ReactBits", "Figma", "Vercel"],
      emoji: "🐾",
      detailsUrl: "https://purrrch.vercel.app",
      githubUrl: socialLinks.repositories.projectOne
    },
    {
      title: "Crestfield Law Group",
      description: "A composed, editorial website for a professional services brand. Emphasis on typographic hierarchy, restraint, and trust.",
      technologies: ["React", "Tailwind CSS", "Figma", "Vercel"],
      emoji: "⚖️",
      detailsUrl: "https://crestfieldlawgroup.vercel.app",
      githubUrl: socialLinks.repositories.projectTwo
    },
    {
      title: "Lando Norris Portfolio",
      description: "A motion-rich tribute site exploring narrative scroll, transitions, and dynamic layouts.",
      technologies: ["React", "Tailwind CSS", "ReactBits", "Framer Motion", "Figma", "Vercel"],
      emoji: "🏎️",
      detailsUrl: "https://lando-norris-portfolio.vercel.app",
      githubUrl: socialLinks.repositories.projectThree
    },
    {
      title: "Shikshak Setu",
      description: "A platform connecting rural schools with qualified teachers. Profile system, admin flows, and skill-based assessments.",
    ...
    {
      title: "Academic Allies",
      description: "A productivity tool for students built around calendar-driven planning and reminders.",
    ...
    {
      title: "Hobby Buddy Matcher",
      description: "A community platform pairing people by shared interests.",
    ...
    >
      ...
      <TooltipProvider delayDuration={200}>
        <div className="container mx-auto px-2 sm:px-4 md:px-6 relative z-10">
          ...
          <div
            key={currentPage}
            className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 max-w-6xl mx-auto mb-8"
            style={{
          ...
          >
              ...
              <Card key={index} className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 relative" style={{
                ...
                <CardHeader>
                  <div className="flex items-start gap-3">
                    <div
                      ...
                      style={{
                        background: isDarkMode ? 'rgba(251,191,212,0.08)' : 'rgba(236,72,153,0.07)',
                        border: isDarkMode ? '1px solid rgba(251,191,212,0.15)' : '1px solid rgba(236,72,153,0.15)',
                      }}
                    >
                      {project.emoji}
                    </div>
                ...
                <CardContent style={{ display: 'flex', flexDirection: 'column' }}>
                  ...
                  <div className="flex gap-3" style={{ marginTop: 'auto', paddingTop: '8px' }}>
                    <a href={project.detailsUrl} className="project-btn flex items-center gap-1" style={{ textDecoration: 'none', color: 'white' }} target="_blank" rel="noopener noreferrer" aria-label={`View ${project.title} project`}>
            ...
            {placeholders.map((placeholder) => (
              <Card key={placeholder.id} className="group relative" style={{
                ...
                <CardHeader>
                  <div className="flex items-start gap-3">
                    <div className="w-12 h-12 rounded-lg flex items-center justify-center text-2xl flex-shrink-0 opacity-40"
                      style={{
                        background: isDarkMode ? 'rgba(251,191,212,0.08)' : 'rgba(236,72,153,0.07)',
                        border: isDarkMode ? '1px solid rgba(251,191,212,0.15)' : '1px solid rgba(236,72,153,0.15)',
                      }}
