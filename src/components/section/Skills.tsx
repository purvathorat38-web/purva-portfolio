...
const Skills = () => {
  ...
  return (
    <section ref={sectionRef} id="skills" className="min-h-screen py-12 sm:py-16 md:py-20 relative" style={{
      ...
      <div className="container mx-auto px-2 sm:px-4 md:px-6 relative" style={{ zIndex: 2 }}>
        <h2 className="text-3xl sm:text-4xl font-bold text-center mb-8 sm:mb-12" style={{ color: isDarkMode ? themeColors.colors.white : themeColors.colors.pink[500] }}>Skills</h2>
        <div
