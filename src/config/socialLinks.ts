...
export const socialLinks = {
  ...
  linkedin: import.meta.env.VITE_LINKEDIN_URL ?? 'https://www.linkedin.com/in/purva-thorat38/',
  ...
  display: {
    ...
    linkedin: (import.meta.env.VITE_LINKEDIN_URL ?? 'https://www.linkedin.com/in/purva-thorat38/').replace('https://', ''),
    email: import.meta.env.VITE_EMAIL ?? 'purvathorat38@gmail.com',
  }
};
